...
import com.lakesidehotel.LakeSideHotel.exeption.PhotoRetrievalExeption;
...
import com.lakesidehotel.LakeSideHotel.service.BookingService;
    ...
    private RoomResponse getRoomRespone(Room room) {
        ...
        if(photoBlob!=null){
            try {
                ...
                throw new PhotoRetrievalExeption("Error retrieving photo");
            }
        }
